...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "2014-11-08 - Kepler-186f";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nTime    = 1415466949;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 2240567;
       ...
       //// debug print
        ...
        genesis.print();
       */
        assert(hashGenesisBlock == uint256("0x0000019a732c071b7dc4a9f2936929ea4441fc45e44c6a3cb3aa421ccdbb1648"));
        assert(genesis.hashMerkleRoot == uint256("0x09083437fd2f8415b4494b7155c6c98b07bed43a4d8187d8a25ba6831554d6f1"));

      //  vSeeds.push_back(CDNSSeedData("keplercoin.com", "keplercoin.com"));
        vSeeds.push_back(CDNSSeedData("131.72.137.93", "131.72.137.93"));


        base58Prefixes[PUBKEY_ADDRESS] = 45; //Keplercoin address starts with K
    ...
    CTestNetParams() {
      ...
      //  while (hashGenesisBlock > bnProofOfWorkLimit[ALGO_SHA256D].getuint256()){
       //     if (++genesis.nNonce==0) break;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testseed1.keplercoin.org", "testseed1.keplercoin.org"));
